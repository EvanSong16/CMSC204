...
public class BasicDoubleLinkedList_STUDENT_Test {
	...
	public void setUp() throws Exception {
		...
		linkedDouble.addToEnd(3.14);
		linkedDouble.addToEnd(1337.1337);
		linkedDouble.addToEnd(12345.6789);
	...
	public void testAddToEnd() {
		assertEquals(12345.6789, linkedDouble.getLast(), 0.0001);
	...
	public void testAddToFront() {
		assertEquals(3.14, linkedDouble.getFirst(), 0.01);
	...
	public void testToArrayList()
	{
		...
		assertEquals(3.14, dArr.get(1), 0.01);
		assertEquals(1337.1337, dArr.get(2), 0.0001);
		assertEquals(12345.6789, dArr.get(3), 0.0001);
	...
	public void testIteratorSuccessfulNext() {
		...
		assertEquals(3.14, iterator.next(), 0.01);
		assertEquals(1337.1337, iterator.next(), 0.0001);
		assertEquals(true, iterator.hasNext());
		assertEquals(12345.6789, iterator.next(), 0.0001);
	...
	public void testIteratorSuccessfulPrevious() {
		...
		assertEquals(12345.6789, iterator.previous(), 0.0001);
		assertEquals(1337.1337, iterator.previous(), 0.0001);
		assertEquals(3.14, iterator.previous(), 0.01);
	...
	public void testRemove() {
		...
		assertEquals(3.14, linkedDouble.getFirst(), 0.01);
		assertEquals(12345.6789, linkedDouble.getLast(), 0.01);
		assertEquals(linkedDouble.getSize(), 3);
		linkedDouble.remove(1337.1337, dComp);
		assertEquals(3.14, linkedDouble.getFirst(), 0.0001);
		assertEquals(12345.6789, linkedDouble.getLast(), 0.0001);
	...
	public void testRetrieveFirstElement() {
		assertEquals(3.14, linkedDouble.retrieveFirstElement(), 0.01);
		linkedDouble.addToFront(44.654);
		assertEquals(44.654, linkedDouble.retrieveFirstElement(), 0.001);
		assertEquals(1337.1337, linkedDouble.retrieveFirstElement(), 0.0001);
	}

	@Test
	public void testRetrieveLastElement() {
		assertEquals(12345.6789, linkedDouble.retrieveLastElement(), 0.0001);
		linkedDouble.addToEnd(44.654);
		assertEquals(44.654, linkedDouble.retrieveLastElement(), 0.001);
		assertEquals(1337.1337, linkedDouble.retrieveLastElement(), 0.0001);
	}
